...
"}")
        ...
        self.selector_ventana.addItem("")
        self.gridLayout.addWidget(self.selector_ventana, 2, 1, 1, 1)
        ...
        self.selector_grafico.addItem("")
        self.selector_grafico.addItem("")
        self.gridLayout.addWidget(self.selector_grafico, 2, 0, 1, 1)
        self.boton_limpiar = QtWidgets.QPushButton(self.marco_graficos)
        self.boton_limpiar.setObjectName("boton_limpiar")
        self.gridLayout.addWidget(self.boton_limpiar, 3, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.boton_etapa2, 1, 0, 1, 1)
