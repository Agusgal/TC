...
"}")
        ...
        self.ventana_grafica2.setMaximumSize(QtCore.QSize(16777215, 450))
...
"}")
        ...
        self.marco_parametros.setMaximumSize(QtCore.QSize(280, 300))
...
"}")
        ...
        self.ventana_polos_zeros = MplWidget(self.marco_graficos)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
