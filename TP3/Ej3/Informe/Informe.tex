...
Sin embargo las tolerancias de los componentes no lo permiten. Es por tal motivo que para alcanzar dicha precisión los fabricantes construyen dichas resistencias durante el proceso de fabricación del IC con el fin de minimizar esas diferencias.
...
Se diseño un puente de WheatStone para la generación de señales.
\begin{figure}[H]
	\centering
