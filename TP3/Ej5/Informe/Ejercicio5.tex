...
\begin{figure}[H]	
	\centering
	\includegraphics[width=0.8\textwidth]{Imagenes/CBodes-Ph-4.png}
	\caption{Diagrama de Bode en fase de la cuarta medición.}
	\label{fig:CBodes-Ph-4}
\end{figure}

Como se mostró en las Figuras (\ref{fig:MC-Mod}) y (\ref{fig:MC-Ph}), el hecho de poseer componentes con tolerancia del 1\%, se termina de ver reflejado en las comparaciones previamente hechas.
...
\begin{figure}[H]	
	\centering
	\includegraphics[width=0.8\textwidth]{Imagenes/ZinCompMod.png}
	\caption{Impedancia de entrada en modulo.}
	\label{fig:ZinCompMod}
\end{figure}
\begin{figure}[H]	
	\centering
	\includegraphics[width=0.8\textwidth]{Imagenes/ZinCompPh.png}
