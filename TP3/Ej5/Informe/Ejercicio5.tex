...
De la misma forma, se muestra la impedancia de entrada en función de la frecuencia para el circuito total. Debido a que se colocaron las tres instancias en serie, $Z_{In_{T}}$ es la suma de impedancia de cada instancia. Debido a que al variar $\psi$ para cada instancia resultó indistinto para cada caso, se muestra simplemente una única representación de como depende la impedancia de entrada, variando el coeficiente antes mencionado de una única etapa y fijando los demás en $0,5$.
\begin{figure}[H]
\centering
