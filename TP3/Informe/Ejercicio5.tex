...
Finalmente se realiza un breve comentario acerca su implementación. Se procedió a introducir a la entrada del circuito senoidales de una frecuencia dada, mientras que a la salida se colocaron parlantes para poder escuchar como esta resulta afectada por cada instancia. Posteriormente se procedió realizar un experimento similar, pero esta vez colocando música a la entrada, más específicamente, ``Come as you are'' de Nirvana. Dicha experiencia fue grabada y se anexa en video junto con el informe. 