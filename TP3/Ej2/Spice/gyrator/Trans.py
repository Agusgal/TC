...
data = read_file_spice("ZinL.txt")#Bode1
data1 = read_file_spice("ZinG.txt")#Bode1
...
plt.ylabel('Impedancia de Entrada [Ohm]')
...
plt.title("Impedancia de entrada L vs Gyrator")
plt.grid()
plt.legend()
plt.show()
...
plt.xlabel('Frecuencia [Hz]')
plt.ylabel('Impedancia de Entrada [°]')
plt.grid()
plt.legend()
plt.show()