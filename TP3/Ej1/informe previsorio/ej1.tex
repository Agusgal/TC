...
\toprule
- & $\omega_z$ & $\omega_p$ & $G_{Banda Pasante}$  & $G_{Notch}$ & $G_{Banda Atenuante}$ \\ \midrule
Valor deseado & $2926Hz$ & $2069Hz$ & $0$ & $-$ & $-$ \\
Valor calculado & $2930Hz$ & $-$ & $0$ & $-77dB$ & $-7dB$ \\ 
Error & $0.135\%$ & $-$ & $0\%$ & $-$ & $-$ \\ \bottomrule
\end{tabular}
