...
\begin{tabular}{@{}cccc@{}}
\toprule
Componente & Valor Teórico & Implementación & Valor Final \\ \midrule
$C_2$ & $15nF$ & $15nF$ & $15nF$ \\
$C_7$ & $11.25nF$ & $10nF//1.2nF$ & $11.2nF$ \\
$C_6$ & $3.75nF$ & $3.3nF//470pF$ & $3.77nF$ \\
$R_{1,3,4,8}$ & $5128.2 \Omega$ & $5K6\Omega//62K\Omega$ & $5136.1 \Omega$ \\
$R_{6,7}$ & $20512.82 \Omega$ & $39K\Omega//43K\Omega$ & $20451.21\Omega$ \\ \bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
	...
	\end{subfigure}
	\label{fig:bode_calc}
	\caption{Gráficos de Bode para el filtro con los componentes calculados.}
\end{figure}

\subsection{Simulación del Circuito}

Se procedió a realizar la simulación del circuito.

hablar mas y grafico de bode
...
\begin{figure}[H]
	...
	\caption{Comparación entro los gráficos de bode simulados y calculados teóricamente.}
\end{figure}
