...
\begin{equation}
 y(t) = \frac{2}{RC \sqrt{3}} \left( e^{-t\frac{2 + \sqrt{3}}{RC}} - e^{t\frac{\sqrt{3} - 2}{RC}} \right) + \frac{1}{RC}
\label{equ:h*u}
\end{equation} 
...
Graficando tanto el modulo de la respuesta en frecuencia en decibles y los armónicos simulados se obtiene la siguiente figura.
