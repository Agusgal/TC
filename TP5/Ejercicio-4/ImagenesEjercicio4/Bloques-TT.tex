...
\begin{tikzpicture}
	...
	node at (aux1) [above = 15mm, left=15mm] (aux2) {}
	...
	\draw[->, rounded corners] (aux1.center) |- (aux2.center);
	\draw[->, rounded corners] (aux2.center) -| (suma1);
	\draw[->] (aux1.center) -- (wo2);
	\draw[->] (wo2) -- (int2);
	\draw[->] (int2) -- (b-aux);
	\draw[->, rounded corners] (b-aux) -| (suma1);
