...
Además, el termino $K$ previamente establecido, varía para cada salida. $K(PB)$ representa la ganancia en continua para el pasa bajos, $K(PBanda)$ la ganancia en la frecuencia de resonancia del pasa banda y para el pasa altos, $K(PA)$ es la ganancia en frecuencia infinita.
\begin{equation}
\begin{split}
	K(PB) = \frac{R_5 + R_6}{R_3 + R_4} \frac{R_4}{R_6}	\	\	\ con \ \omega = 0 \\
	K(PBanda) = -\frac{R_4}{R_3}	\	\	\ con \ \omega = \omega_o \\
