...
\begin{figure}[H]
	...
	\label{fig:mcrauch}
\end{figure}
Es notable que no existe una gran dispersión debido a los componentes en el diagrama de bode, siendo en la primer etapa la única donde se consideraría utilizar un preset.  
\subsubsection{Filtro definitivo.}

También se midió la respuesta en frecuencia del filtro obteniendo los siguientes resultados:
\begin{figure}[H]
	\centering
