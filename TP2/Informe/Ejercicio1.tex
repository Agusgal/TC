...
Se puede observar en todos los casos como la frecuencia de corte de las transferencias son iguales, mientras que la pendiente en las transferencias medidas y simuladas difieren de la teórica. Esto se debe a las puntas del osciloscopio cuyas capacitancias son de $\approx80pF$. Al pasar a las altas frecuencias, el capacitor presenta cada vez menor impedancia, atenuando la tensión de salida del circuito y generando en consecuencia un filtro de segundo orden con el polo ya existente.
