...
Con la finalidad de obtener resultados predecibles e independizarse los más posible de los polos parasitos del amplificador operacional y garantizar la estabilidad, los fabricantes añaden el llamado \textbf{polo dominante}.
...
\begin{figure}[H]
	...
	\caption{Ganancia con $A_{vol}(s)$ finito Circuito Derivador}
\end{figure}
...
En el rango de frecuencias bajas esta configuración presenta una atenuación significante por lo que la amplitud de la señal de entrada sera un factor critico 
