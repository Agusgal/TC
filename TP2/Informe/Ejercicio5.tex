...
Se realizaron las mismas simulaciones para el diseño propuesto que las hechas para el diseño base. A continuación se analizarán las diferencias y el funcionamiento del circuito.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth, trim={0 0 0 0}, clip]{Ejercicio5/Imagenes/Circuito_base/Sim/circuito_propuesto_fourier_alone.png}
	\caption{Análisis de las componentes de fourier y la distorsión armónica total para el circuito propuesto con ambos pares de diodos desconectados.}
	\label{fig:sim_prop_fourier_alone}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth, trim={0 0 0 0}, clip]{Ejercicio5/Imagenes/Circuito_base/Sim/circuito_propuesto_fourier_soft.png}
	\caption{Análisis de las componentes de fourier y la distorsión armónica total para el circuito propuesto con el par de diodos en el lazo de realimentación conectado.}
	\label{fig:sim_prop_fourier_soft}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth, trim={0 0 0 0}, clip]{Ejercicio5/Imagenes/Circuito_base/Sim/circuito_propuesto_fourier_hard.png}
	\caption{Análisis de las componentes de fourier y la distorsión armónica total para el circuito propuesto con el par de diodos a la salida del operacional conectado.}
	\label{fig:sim_prop_fourier_hard}
\end{figure}
