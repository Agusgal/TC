...
Luego, se encuentran en el circuito una resistencia en serie con un par de diodos en paralelo con polaridad invertida. Estos diodos fijarían la tensión de la señal en $V_{d_{on}}$.

\subsubsection{Bypass total del circuito}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth, trim={0 0 0 0}, clip]{Ejercicio5/Imagenes/circuito_base_bypass.png}
	\caption{Bypass del circuito.}
	\label{fig:circuito_base_bypass}
\end{figure}
