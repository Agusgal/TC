...
\begin{circuitikz}[american currents]
	\node [op amp](A1){};
%	\draw (A1.-) to[short] ++(-1,0) to[R, l = $R_5$, i<=$I_{R6}$] ++(-2,0) to[short, -o] node[ocirc, label=left:$V_{LM35}$]{} ++(-1,0);
	\draw (A1.-) to[short] ++(-1,0) to[R, l = $R_5$] ++(-2,0) to[short, -o] node[ocirc, label=left:$V_{LM35}$]{} ++(-1,0);
...
%	\draw (A1.-) to[short] ++(-1,0) to[R, l_=$R_1$, i<_=$I_{R1}$] ++(-2,0) to[short, -o] node[ocirc,label=left:$V_{1}$]{} ++(-1,0);
	\draw (A1.-) to[short] ++(-1,0) to[R, l_=$R_1$] ++(-2,0) to[short, -o] node[ocirc,label=left:$V_{1}$]{} ++(-1,0);
	\draw (A1.-) node[label=south:$V^-$]{};
	\draw (A1.+) node[label=south:$V^+$]{};
...
%	\draw (A1.+) to[short] ++(-1,0) to[R, l= $R_2$, i<_=$I_{R2}$] ++(-2,0) to[short, -o] node[ocirc,label=left:$-Vcc$]{} ++(-1,0);
	\draw (A1.+) to[short] ++(-1,0) to[R, l= $R_2$] ++(-2,0) to[short, -o] node[ocirc,label=left:$-Vcc$]{} ++(-1,0);
\end{circuitikz}
